...
public class LinkedPositionalList<E> implements PositionalList<E> {
     ...
     * call.
     *
     * @param pred node just before the location where the new element is
     * inserted
     * @param succ node just after the location where the new element is
     * inserted
    ...
    //---------------- lớp ElementIterator lồng nhau ----------------
    // Lớp này điều chỉnh phép lặp được tạo ra bởi các vị trí () để trả về các phần tử. 
    ...
    // Trả về một trình lặp của các phần tử được lưu trữ trong danh sách.
    @Override
